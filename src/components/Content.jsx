...
export const Content = ({
	...
	return (
		<div className="flex flex-col bg-white dark:bg-gray-900 w-full">
			...
			<button
				onClick={onMenuClick}
				className="flex fixed md:hidden top-4 left-32 p-2 gap-2 rounded-lg bg-gray-200 dark:bg-gray-700 text-gray-800 hover:text-gray-800 dark:text-gray-400 dark:hover:text-white z-10">
				<Bars3Icon className="size-6" /> Module
			</button>
			<main className="flex-1 mt-8 md:mt-0 p-8 md:p-12 pb-28">
